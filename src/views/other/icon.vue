...
<template>
  <div class="page-bg">
    <ul class="icon_lists dib-box">
      ...
      <li class="dib">
        <span class="icon custom-icon">&#xe690;</span>
        <div class="name">图标_支付-钱包支付-94</div>
        <div class="code-name">&amp;#xe690;</div>
      </li>
      ...
      <li class="dib">
        <span class="icon custom-icon">&#xe68f;</span>
        <div class="name">图标_支付_支付宝支付</div>
        <div class="code-name">&amp;#xe68f;</div>
      </li>
      ...
      <li class="dib">
        <span class="icon custom-icon">&#xe62e;</span>
        <div class="name">就诊人管理</div>
        <div class="code-name">&amp;#xe62e;</div>
      </li>

      <li class="dib">
        <span class="icon custom-icon">&#xe631;</span>
        <div class="name">就诊提醒</div>
        <div class="code-name">&amp;#xe631;</div>
      </li>
      ...
      <li class="dib">
        <span class="icon custom-icon">&#xe625;</span>
        <div class="name">组织页面</div>
        <div class="code-name">&amp;#xe625;</div>
      </li>

      <li class="dib">
        <span class="icon custom-icon">&#xe626;</span>
        <div class="name">数字签名</div>
        <div class="code-name">&amp;#xe626;</div>
      </li>
      ...
      <li class="dib">
        <span class="icon custom-icon">&#xe676;</span>
        <div class="name">绑定-01</div>
        <div class="code-name">&amp;#xe676;</div>
      </li>

      <li class="dib">
        <span class="icon custom-icon">&#xe61c;</span>
        <div class="name">yly_计算器</div>
        <div class="code-name">&amp;#xe61c;</div>
      </li>

      <li class="dib">
        <span class="icon custom-icon">&#xe61d;</span>
        <div class="name">商铺 商城 首页 房子</div>
        <div class="code-name">&amp;#xe61d;</div>
      </li>
